...
namespace C14_Ex02
{
    public class ApplicationManger
    {
        ...
        private ISmartPostStatus m_SmartPostStatus;
        ...
        {
            m_SmartPostStatus.PostAndBackupStatus(i_Messege);
        ...
        public LoginResult ConnectToFacebook()
        {
            ...
            m_SmartPostStatus = new UserAdapter(m_FacebookUser);
            return loginSession;
        }

        public string FetchCurrentFeedMessege()
        {// $G$ SFN-001 (-10) Feature is not working and causes crash.
