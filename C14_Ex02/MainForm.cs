    ...
    public partial class MainForm : Form
    {
        ...
        private void fetchAllFriends()
        {
            ...
            foreach (User friend in friends)
            {
                ...
                checkedListBoxEvents.Items.Add(fullFriend);
            }
        }
        ...
        private void fetchEventsList(User i_Friend, ListBox i_ListToFill)
        {
            ...
            FacebookObjectCollection<Event> myEvents = m_Manger.FetchUserEvents(i_Friend);
            foreach (Event friendEvent in myEvents)
            {
                i_ListToFill.Items.Add(friendEvent);
            }
        }
